...
$ns bandwidth $nodes(bs1) $nodes(ms) 64000 duplex
$ns bandwidth $nodes(bs2) $nodes(ms) 38000 duplex

$ns delay $nodes(bs1) $nodes(ms) 0.150 duplex
$ns delay $nodes(bs2) $nodes(ms) 0.150 duplex
